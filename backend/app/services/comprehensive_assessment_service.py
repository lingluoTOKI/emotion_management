...
class ComprehensiveAssessmentService:
    ...
    async def _analyze_conversation_comprehensively(self, conversation_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 1. BERT综合分析
            bert_analysis = bert_analyzer.comprehensive_analysis(full_conversation)
            ...
            # 4. 风险评估
            risk_assessment = self._assess_conversation_risks(user_messages, bert_analysis)
    ...
    def _assess_conversation_risks(self, user_messages: List[str], bert_analysis: Dict) -> Dict[str, Any]:
        ...
        # 高风险关键词
        high_risk_keywords = ["自杀", "死亡", "伤害自己", "结束生命", "不想活了", "没有希望"]
        medium_risk_keywords = ["绝望", "无助", "孤独", "痛苦", "折磨", "崩溃", "压力很大"]
        ...
        # 综合风险评分
        total_risk_score = high_risk_count * 5 + medium_risk_count * 2 + bert_risk_score

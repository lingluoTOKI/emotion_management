          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border p-6">
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">🎯 下一步选择</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
                  ...
                  <button 
                    ...
                    className="flex flex-col items-center justify-center p-6 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200"
                  >
                    <BarChart3 className="w-8 h-8 mb-3" />
                    <span className="font-semibold text-lg mb-1">返回仪表板</span>
                    <span className="text-xs text-gray-500 text-center">查看历史记录和其他功能</span>
                  </button>
                </div>
                
                {/* 选项说明 */}
                <div className="mt-6 bg-gray-50 rounded-xl p-4 max-w-4xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                    ...
                    <div className="text-center">
                      <p><strong className="text-gray-600">返回仪表板：</strong>查看评估历史和使用其他功能</p>
                    </div>
                  </div>
                </div>
              </div>

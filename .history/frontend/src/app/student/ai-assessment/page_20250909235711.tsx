        ...
        if (shouldCompleteAssessment()) {
          ...
          if (conversationRounds >= 6) {
            ...
            setTimeout(() => {
              ...
              // 暴露完成函数（临时方案）
              ;(window as any).handleAssessmentCompletion = completeAssessmentFlow
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div 
                ...
                onClick={() => {
                  if (canManuallyComplete && (window as any).handleAssessmentCompletion) {
                    console.log('👆 用户手动触发评估完成')
                    setCanManuallyComplete(false)
                    ;(window as any).handleAssessmentCompletion()
                  }
                }}
              >
            ...
            >
                ...
                {canManuallyComplete && (
                  <motion.div
                    ...
                    onClick={() => {
                      if ((window as any).handleAssessmentCompletion) {
                        console.log('👆 用户点击按钮手动触发评估完成')
                        setCanManuallyComplete(false)
                        ;(window as any).handleAssessmentCompletion()
                      }
                    }}

...
```bash
cd database
python detect_mysql_env.py  # 检测环境
python generate_config.py   # 生成配置
...
cd database
# 确保MySQL root用户有足够权限
mysql -u root -p -e "GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost'; FLUSH PRIVILEGES;"
```
...
| 👨‍🎓 学生 | `student2` | `123456` | 体验学生端所有功能 |
| 👨‍🎓 学生 | `student3` | `123456` | 体验学生端所有功能 |
| 👨‍🎓 学生 | `student4` | `123456` | 体验学生端所有功能 |
| 👩‍⚕️ 咨询师 | `counselor1` | `123456` | 体验咨询师工作台 |
| 👩‍⚕️ 咨询师 | `counselor2` | `123456` | 体验咨询师工作台 |
| 👩‍⚕️ 咨询师 | `counselor3` | `123456` | 体验咨询师工作台 |
| 👨‍💼 管理员 | `admin` | `123456` | 体验管理后台和数据分析 |
...
│   ├── deploy_database.bat # 完整部署脚本
│   ├── detect_mysql_env.py # MySQL环境检测
...
| 学生 | student2 | 123456 | 心理评估、AI聊天、咨询预约 |
| 学生 | student3 | 123456 | 心理评估、AI聊天、咨询预约 |
| 学生 | student4 | 123456 | 心理评估、AI聊天、咨询预约 |
| 咨询师 | counselor1 | 123456 | 学生管理、咨询服务、报告查看 |
| 咨询师 | counselor2 | 123456 | 学生管理、咨询服务、报告查看 |
| 咨询师 | counselor3 | 123456 | 学生管理、咨询服务、报告查看 |
| 管理员 | admin | 123456 | 系统管理、用户管理、数据分析 |

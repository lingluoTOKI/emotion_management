...
class ComprehensiveAssessmentService:
    ...
    def _integrate_assessment_results(self, 
        ...
        if risk_assessments:
            ...
            # 检查是否有任何高风险指标
            has_high_risk_indicators = any(ra["risk_level"] == "high" for ra in risk_assessments)
            
            if has_high_risk_indicators and weighted_risk_score >= 5:
